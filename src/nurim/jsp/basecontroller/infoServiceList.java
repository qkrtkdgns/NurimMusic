...
@WebServlet("/info_service_list.do")
public class infoServiceList extends BaseController {
	private static final long serialVersionUID = -828635548907875254L;
