...
@WebServlet("/login_page_ok.do")
public class LoginPageOk extends BaseController {
	private static final long serialVersionUID = 5984993748541052410L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String userPw = web.getString("password");
