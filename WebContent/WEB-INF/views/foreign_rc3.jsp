        ...
        <div class="foreign_rc">
            ...
            <div class="list-topbar">
               ...
               <div class="search_list">
                  		<a href="${pageContext.request.contextPath}/foreign_rc3.do?CList=Reg&keyword1=${keyword1}&keyword2=${keyword2}">발매일
						</a>&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="${pageContext.request.contextPath}/foreign_rc3.do?CList=high&keyword1=${keyword1}&keyword2=${keyword2}">높은가격
						</a>&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="${pageContext.request.contextPath}/foreign_rc3.do?CList=row&keyword1=${keyword1}&keyword2=${keyword2}">낮은가격
						</a>
               </div>
               <!-- //원하는 카테고리순 정렬 끝 -->
            </div>
	...
	<div class="page_num">
		<ul class="pagination pagination-mg">
			...
			<c:when test="${pageHelper.prevPage > 0}">
				...
				<c:url var="prevUrl" value="/foreign_rc3.do">
			...
			<c:url var="pageUrl" value="/foreign_rc3.do">
					<c:param name="category" value="${category}" />
					<c:param name="keyword" value="${keyword}" />
			...
			<c:when test="${pageHelper.nextPage > 0}">
				...
				<c:url var="nextUrl" value="/foreign_rc3.do">
					<c:param name="category" value="${category}" />
					<c:param name="keyword" value="${keyword}" />
			...
			<!-- 검색 영역 -->
		<form action="${pageContext.request.contextPath}/foregin_rc3.do" method="get">
