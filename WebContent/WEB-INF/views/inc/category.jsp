...
<%@ page trimDirectiveWhitespaces="true" %>
    ...
    <div class="side_area">
            <a href="${pageContext.request.contextPath }/kor.do">국내음반</a>
            <ul>
               <li><a href="${pageContext.request.contextPath }/kor_rc1.do">♪ K-POP</a></li>
             ...
             <a href="${pageContext.request.contextPath }/foreign.do">해외음악</a>
            <ul>
            ...
            <ul>
               ...
               <li><a href="${pageContext.request.contextPath }/shopping_headphone.do">♪ 해드폰</a></li>
            </ul>
         </div>