...
<!-- 본문내용 작성 start -->
    ...
    <div class="goods_list">
        <div class="list-topbar">
          ...
          <a href="${pageContext.request.contextPath}/shopping_earphone.do?CList=Reg&keyword1=${keyword1}&keyword2=${keyword2}">발매일
						</a>&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="${pageContext.request.contextPath}/shopping_earphone.do?CList=high&keyword1=${keyword1}&keyword2=${keyword2}">높은가격
						</a>&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="${pageContext.request.contextPath}/shopping_earphone.do?CList=row&keyword1=${keyword1}&keyword2=${keyword2}">낮은가격
						</a>
          </div>
        </div>
	...
	<div class="page_num">
		<ul class="pagination pagination-mg">
			...
			<c:when test="${pageHelper.prevPage > 0}">
				...
				<c:url var="prevUrl" value="/shopping_earphone.do.do">
			...
			<c:url var="pageUrl" value="/shopping_earphone.do.do">
					<c:param name="category" value="${category}" />
					<c:param name="keyword" value="${keyword}" />
			...
			<c:when test="${pageHelper.nextPage > 0}">
				...
				<c:url var="nextUrl" value="/shopping_earphone.do.do">
					<c:param name="category" value="${category}" />
				 	<c:param name="keyword" value="${keyword}" />
