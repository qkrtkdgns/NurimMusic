...
<!-- 본문내용 작성 start -->
		...
		<div class="goods_list">
				<div class="list-topbar">
					...
					<div class="search_list">
						...
						<a href="${pageContext.request.contextPath}/kor_rc3.do?CList=high&keyword1=${keyword1}&keyword2=${keyword2}">높은가격
						</a>&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="${pageContext.request.contextPath}/kor_rc3.do?CList=row&keyword1=${keyword1}&keyword2=${keyword2}">낮은가격
						</a>
					</div>
				</div>
	...
	<div class="page_num">
		...
		<!-- 검색 영역 -->
		<form action="${pageContext.request.contextPath}/kor_rc3.do" method="get">
