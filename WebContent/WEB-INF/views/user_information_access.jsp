...
<!-- 본문내용 작성 start -->
			<div id="content">
				...
				<hr/>
				<div class="pw_check" style="margin-top:30px;  height:36px; border-bottom:1px solid #ccc;">
				...
				<div style="width:100px;height:175px; margin:30px auto;">
					<a href="${pageContext.request.contextPath }/user_information.do"><button id="btbt" type="button" class="btn purple" style="width:100px;">확인</button></a>
				</div>
				<form>
			</div>
<!--본문내용 작성 end -->
