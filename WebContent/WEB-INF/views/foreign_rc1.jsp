            ...
            <div class="list-topbar">
               ...
               <div class="check_list">
                  ...
                  <button class="btn btn-default btn-sm"  id="basket_list">장바구니 담기</button>
                   <input type="hidden"  name="basket"  id="check" value="${product.id}" >
               </div>
               <!-- //체크한 음반 끝 -->
               
               <!-- 원하는 카테고리순 정렬 -->
               <div class="search_list">
                 		<a href="${pageContext.request.contextPath}/foreign_rc1.do?CList=Reg&keyword1=${keyword1}&keyword2=${keyword2}">발매일
						</a>&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="${pageContext.request.contextPath}/foreign_rc1.do?CList=high&keyword1=${keyword1}&keyword2=${keyword2}">높은가격
						</a>&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="${pageContext.request.contextPath}/foreign_rc1.do?CList=row&keyword1=${keyword1}&keyword2=${keyword2}">낮은가격
						</a>
               </div>
               <!-- //원하는 카테고리순 정렬 끝 -->
            </div>
	...
	<div class="page_num">
		<ul class="pagination pagination-mg">
			...
			<c:when test="${pageHelper.prevPage > 0}">
				...
				<c:url var="prevUrl" value="/foreign_rc1.do">
			...
			<c:url var="pageUrl" value="/foreign_rc1.do">
					<c:param name="category" value="${category}" />
					<c:param name="keyword" value="${keyword}" />
			...
			<c:when test="${pageHelper.nextPage > 0}">
				...
				<c:url var="nextUrl" value="/foreign_rc1.do">
					<c:param name="category" value="${category}" />
					<c:param name="keyword" value="${keyword}" />
		...
		<!-- 검색 영역 -->
		<form action="${pageContext.request.contextPath}/foregin_rc1.do" method="get">
