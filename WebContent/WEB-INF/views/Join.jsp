...
<!-- 본문내용 작성 start -->
			<div id="content">
					<h2>회원가입/Join us</h2><hr>
				<div class="substance_header">
					<h4>이용약관</h4>
					<div class="substance">
					<textarea readonly="readonly" style="resize: none; width:98%; height:90%;">

제1조(목적) 

이 약관은 누림뮤직 회사(전자거래 사업자)가 운영하는 누림뮤직 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. 
※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」 


제2조(정의) 

① "몰"이란 누림뮤직 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다. 
...
② "몰"과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다. 
					...
					<div id="agreement">
					<label>
					<input type="radio" name="agreementA" id="agreement1" value="ok">&nbsp;동의</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<label>
					<input type="radio" name="agreementA" id="agreement2" value="no">&nbsp;동의하지 않음.</label>
					</div>
					</div>
...
누림뮤직은 이용자의 개인정보보호방침 또는 이용약관의 내용에 대해 「동의합니다」버튼 또는 「동의하지 않습니다」버튼을 클릭할 수 있는 절차를 마련하여, 「동의합니다」버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다.
...
대부분의 서비스는 별도의 사용자 등록이 없이 언제든지 사용할 수 있습니다. 그러나 누림뮤직은 회원서비스를 통하여 이용자들에게 맞춤식 서비스를 비롯한 보다 더 향상된 양질의 서비스를 제공하기 위하여 다음과 같은 목적으로 이용자 개인의 정보를 수집 · 이용하고 있습니다.
...
누림뮤직은 이용자들이 회원서비스를 이용하기 위해 회원으로 가입하실 때 서비스 제공을 위한 필수적인 정보들을 온라인상에서 입력 받고 있습니다. 
<회원가입>
...
누림뮤직은 비회원 고객 또한 물품 및 서비스 상품의 구매를 하실 수 있도록 하고 있습니다. 누림뮤직은 비회원 주문의 경우 배송 및 대금 결제, 상품 배송에 반드시 필요한 개인정보만을 이용자에게 요청하고 있습니다.
누림뮤직에서 비회원으로 구입을 하신 경우 비회원 이용자가 입력한 지불인 정보 및 수령인 정보는 대금 결제 및 상품 배송에 관련한 용도 외에는 다른 어떠한 용도로도 사용되지 않습니다.

5. 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항

누림뮤직은 이용자들에게 특화된 맞춤서비스를 제공하기 위해서 이용자의 정보를 저장하고 수시로 불러오는 세션(session)방식을 사용하고 있습니다. 
- 세션이란? 
...
이용자가 쇼핑몰 회원으로서 회사에 제공하는 서비스를 이용하는 동안 누림뮤직은 이용자들의 개인정보를 계속적으로 보유하며 서비스 제공 등을 위해 이용합니다. 다만, 개인정보취급방침 전체 내용 중 "8. 개인정보의 열람, 정정, 삭제" 에서 설명한 절차와 방법에 따라 이용자 본인이 직접 삭제하거나 수정한 정보, 가입해지를 요청한 경우에는 재생할 수 없는 방법에 의하여 디스크에서 완전히 삭제하며 추후 열람이나 이용이 불가능한 상태로 처리됩니다.
...
그리고 상법, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계법령의 규정에 의하여 보존할 필요가 있는 경우 누림뮤직은 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다. 이 경우 누림뮤직은 보관하는 정보를 그 보관의 목적으로만 이용하며 보존기간은 아래와 같습니다.

- 계약 또는 청약철회 등에 관한 기록 : 5년
- 대금결제 및 재화 등의 공급에 관한 기록 : 5년
- 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년

누림뮤직은 귀중한 이용자의 개인정보를 안전하게 처리하며, 유출의 방지를 위하여 다음과 같은 방법을 통하여 개인정보를 파기합니다.
종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각을 통하여 파기합니다. 전자적 파일 형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다.

					</textarea>
					<div id="agreement">
					<label>
					<input type="radio" name="agreementB" id="agreement3" value="ok">&nbsp;동의</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<label>
					<input type="radio" name="agreementB" id="agreement4" value="no">&nbsp;동의하지 않음.</label>
					</div>
					</div>
					</div>

		<div class="agreement_button">
		<a href="${pageContext.request.contextPath }/join2.do" id="OK"><img src="${pageContext.request.contextPath }/img/btn_join.gif"></a>
		<a href="#" onclick="history.back();" id="NO"><img src="${pageContext.request.contextPath }/img/btn_back.gif"></a>
		</div>
	 	...
	 	$(document).ready(function(){
            ...
            $("#OK").click(function(){    
                if($("#agreement1").is(":checked") == false){
                    ...
                    alert("개인정보 취급 방침 약관에 동의 하셔야 다음 단계로 진행 가능합니다..");
                    return false;
                }else{
                    return true;
                }
