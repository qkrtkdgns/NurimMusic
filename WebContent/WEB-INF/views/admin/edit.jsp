...
<body>
	<div id="container">
		...
		<!-- 컨텐츠 영역 start -->
		<div id="content">
			<form method="post" action="../admin/edit_ok.do" enctype="multipart/form-data">
				<table>
					<tbody>
						<tr>
							<th colspan="2">상품명</th>
						...
						<tr>
							...
							<td><input type="radio" name="sal_no" id="sal_yes" checked />수량&nbsp;<input
								type="text" name="no" id="no" value="1" class="text-right" />개&nbsp;&nbsp;&nbsp;&nbsp;<input
								type="radio" name="sal_no" id="sal_no" />품절</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="provide" id="provide"
								class="form-control" /></td>
						</tr>
						<tr>
