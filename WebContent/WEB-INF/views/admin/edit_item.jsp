		...
		<div id="content">
			...
			<table>
					<tbody>
						<tr>
							<th colspan="2">상품명</th>
							<td><input type="text" name="title" id="title" />${product.proName}</td>
						</tr>
						<tr>
							<th colspan="2">일반 판매가</th>
							<td><input type="text" name="price" id="price" />${product.proPrice}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="file" name="file" id="file"  value="${product.proCategoryName}"/></td>
						</tr>
						<tr>
							...
							<option value="${product.proCategoryName}">${product.proCategoryName}</option>
							</select>
						</td>
						</tr>
						<tr>
							...
							<td><input type="text" name="provider" id="provider"
								class="form-control" />${product.provider}</td>
						</tr>
						<tr>
