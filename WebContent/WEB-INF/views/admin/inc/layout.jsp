...
<script type="text/javascript" src="${pageContext.request.contextPath}/admin_assets/js/delete.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/admin_assets/js/checkbox.js"></script>
