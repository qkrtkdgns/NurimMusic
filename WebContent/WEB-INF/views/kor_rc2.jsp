				...
				<div class="list_lineup">
					<ul>
						<li>
							<table>
								...
								<td width="145">
								<a href="${pageContext.request.contextPath }/item.do"><img src="${pageContext.request.contextPath }/img/list_image11.jpg"></a>
								</td>
								<td width="493">
								...
								<td width="183"><p class="price1">42,500원</p>
					...
					<li>
							<table>
								...
								<td style="width:10;"><input type="checkbox" name="basket"></td>
								<td width="145">
								<a href="${pageContext.request.contextPath }/item.do"><img src="${pageContext.request.contextPath }/img/list_image12.jpg"></a>
								</td>
								<td width="493">
						...
						<li>
							<table>
								...
								<td style="width:10;"><input type="checkbox" name="basket"></td>
								<td width="145">
								<a href="${pageContext.request.contextPath }/item.do"><img src="${pageContext.request.contextPath }/img/list_image13.jpg"></a>
								</td>
								<td width="493">
						...
						<br/>
							...
							<table>
								...
								<td style="width:10;"><input type="checkbox" name="basket"></td>
								<td width="145">
								<a href="${pageContext.request.contextPath }/item.do"><img src="${pageContext.request.contextPath }/img/list_image14.jpg"></a>
								</td>
								<td width="493">
						...
						<li>
							<table>
								...
								<td style="width:10;"><input type="checkbox" name="basket"></td>
								<td width="145">
								<a href="${pageContext.request.contextPath }/item.do"><img src="${pageContext.request.contextPath }/img/list_image15.jpg"></a>
								</td>
								<td width="493">
						...
						<br/>
							...
							<table>
								...
								<td style="width:10;"><input type="checkbox" name="basket"></td>
								<td width="145">
								<a href="${pageContext.request.contextPath }/item.do"><img src="${pageContext.request.contextPath }/img/list_image16.jpg"></a>
								</td>
								<td width="493">
						...
						<br/>
							...
							<table>
								...
								<td style="width:10;"><input type="checkbox" name="basket"></td>
								<td width="145">
								<a href="${pageContext.request.contextPath }/item.do"><img src="${pageContext.request.contextPath }/img/list_image17.jpg"></a>
								</td>
								<td width="493">
						...
						<br/>
							...
							<table>
								...
								<td style="width:10;"><input type="checkbox" name="basket"></td>
								<td width="145">
								<a href="${pageContext.request.contextPath }/item.do"><img src="${pageContext.request.contextPath }/img/list_image18.jpg"></a>
								</td>
								<td width="493">
						...
						<br/>
							...
							<table>
								...
								<td style="width:10;"><input type="checkbox" name="basket"></td>
								<td width="145">
								<a href="${pageContext.request.contextPath }/item.do"><img src="${pageContext.request.contextPath }/img/list_image19.jpg"></a>
								</td>
								<td width="493">
						...
						<br/>
							...
							<table>
								...
								<td style="width:10;"><input type="checkbox" name="basket"></td>
								<td width="145">
								<a href="${pageContext.request.contextPath }/item.do"><img src="${pageContext.request.contextPath }/img/list_image20.jpg"></a>
								</td>
								<td width="493">
